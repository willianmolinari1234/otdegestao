...
export const CAMPOS_DA_FICHA = [
  ...
  { campo: "fotos",          rotulo: "Fotos",                obrigatorio: true,  par: "midia", dica: "Link do Google Drive, como 'qualquer pessoa com o link'. Um por linha.", longo: true, linhas: 2 },
  { campo: "video",          rotulo: "Vídeo",                obrigatorio: true,  par: "midia", dica: "Link do Google Drive. Um por linha.", longo: true, linhas: 2 },
